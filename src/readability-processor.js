...
var ReadabilityProcessor = module.exports.ReadabilityProcessor = function (window, options) {
   ...
   this._extendMode = options.extendMode;
...
ReadabilityProcessor.prototype = {
   ...
   _getCanonicalUrl: function() {
      var linkElements = this._doc.getElementsByTagName("link");
      var canonicalUrl = null;

      this._forEachNode(linkElements, function (element) {
   ...
   _getArticleMetadata: function () {
      ...
      this._forEachNode(metaElements, function (element) {
         ...
         if (this._extendMode) {
            if (elementName) {
               metadata.all[elementName] = element.getAttribute("content");
            }
            if (elementProperty) {
               metadata.all[elementProperty] = element.getAttribute("content");
            }
         }
   ...
   parse: function () {
      ...
      return {
         ...
         metaProperties: metadata.all,
         canonicalUrl: canonicalUrl || this._uri
      };
   }
};
